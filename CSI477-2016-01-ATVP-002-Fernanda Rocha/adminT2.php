...
if(!isset($_SESSION['login_session']) && !isset($_SESSION['senha_session'])){
  ...
  <body>
    ...
    <div class="topo1"></div>
    <center><h3>Seja bem vindo senhor(a) Administrador 2! Escolha uma das opções abaixo para ser feita:</h3></center>


    <a href="atualizarProd.php" class="btn btnCad">Atualizar Produto<a/><b /><b />
